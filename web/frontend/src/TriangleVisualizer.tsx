      ...
      <div className="tv-layout">
        <div className="tv-aspect-ratio-box">
          ...
          <svg className="tv-svg-layer" viewBox={`0 0 ${VIEW_W} ${VIEW_H}`} preserveAspectRatio="xMidYMid meet">
            ...
            */}
            {stage >= 1 && <polygon points="500,150 100,650 900,650" className="tv-skeleton-line" />}
            
            {/* 中层横线: 设 y=483
                左端点 x = (775 - 483) / 1.25 = 292 / 1.25 = 233.6
                右端点 x = (483 + 475) / 1.25 = 958 / 1.25 = 766.4
            */}
            {stage >= 2 && <line x1="233.6" y1="483" x2="766.4" y2="483" className="tv-skeleton-line" />}
            
            {/* 顶层横线: 设 y=316
                左端点 x = (775 - 316) / 1.25 = 459 / 1.25 = 367.2
                右端点 x = (316 + 475) / 1.25 = 791 / 1.25 = 632.8
            */}
            {stage >= 3 && <line x1="367.2" y1="316" x2="632.8" y2="316" className="tv-skeleton-line" />}
            
            {/* 中间竖线 */}
            {stage >= 3 && <line x1="500" y1="316" x2="500" y2="650" className="tv-skeleton-line" />}
          </svg>
          ...
          <div className="tv-content-layer">
            ...
            {/* 三角形内部数字 */}
            {nodes.filter(n => n.kind === "main" && stage >= n.stage).map(node => (
              <div 
                key={node.key} 
                ...
                onMouseEnter={() => setActiveHover({ nodeId: node.key, part: "result" })}
              ...
              >
                ...
                >
                  <div
                    ...
                    onMouseEnter={() => setActiveHover({ nodeId: "ol", part: "result" })}
                  >
                      ...
                      return (
                        <>
                          <span
                            ...
                            onMouseEnter={() => setActiveHover({ nodeId: "ol", part: "a" })}
                          >
                            {a}
                          </span>
                          <span
                            className={activeHover?.nodeId === "ol" && activeHover.part === "b" ? "is-active" : ""}
                            onMouseEnter={() => setActiveHover({ nodeId: "ol", part: "b" })}
                          >
                            {b}
                          </span>
                        </>
              ...
              >
                ...
                >
                  <div
                    ...
                    onMouseEnter={() => setActiveHover({ nodeId: "or", part: "result" })}
                  >
                      ...
                      return (
                        <>
                          <span
                            ...
                            onMouseEnter={() => setActiveHover({ nodeId: "or", part: "a" })}
                          >
                            {a}
                          </span>
                          <span
                            className={activeHover?.nodeId === "or" && activeHover.part === "b" ? "is-active" : ""}
                            onMouseEnter={() => setActiveHover({ nodeId: "or", part: "b" })}
                          >
                            {b}
                          </span>
                        </>
              ...
              >
                ...
                >
                  <div
                    ...
                    onMouseEnter={() => setActiveHover({ nodeId: "down", part: "result" })}
                  >
                      ...
                      return (
                        <>
                          <span
                            ...
                            onMouseEnter={() => setActiveHover({ nodeId: "down", part: "a" })}
                          >
                            {a}
                          </span>
                          <span
                            className={activeHover?.nodeId === "down" && activeHover.part === "b" ? "is-active" : ""}
                            onMouseEnter={() => setActiveHover({ nodeId: "down", part: "b" })}
                          >
                            {b}
                          </span>
                        </>
